...
if ( ! function_exists( 'playground_setup' ) ) :
	...
	function playground_setup() {
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'playground_custom_background_args',
				array(
...
function playground_scripts() {
	...
	wp_enqueue_script( 'playground-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'playground-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );
